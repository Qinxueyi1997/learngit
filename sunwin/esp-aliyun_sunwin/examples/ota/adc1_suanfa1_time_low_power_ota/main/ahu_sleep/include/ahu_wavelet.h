...
#ifndef __ESP_AHU_WAVELET_H__
#define __ESP_AHU_WAVELET_H__
 ...
 */
void wavedec(const double * ori_sign, double * out_sign, int * out_levels,int sign_len,int levels_len);//分解小波
void waverec(const double * dec_details,int * levels,double * rec_sign);//重构小波
void wrcoef(const double * dec_details,int * levels,double * rec_sign);//选定特定层重构小波
#ifdef __cplusplus
}
#endif


#endif /* __ESP_AHU_WAVELET_H__ */
