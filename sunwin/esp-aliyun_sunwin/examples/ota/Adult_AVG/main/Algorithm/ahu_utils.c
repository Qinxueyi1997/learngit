...
void sort_descend(double array[],int size) //閿熸帴杈炬嫹灏忛€夐敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
{
    double temp;//閿熸枻鎷锋椂閿熸枻鎷烽敓鏂ゆ嫹
...
void sort_ascend(double array[],int size) //閿熸枻鎷峰皬閿熸枻鎷烽敓鏂ゆ嫹閫夐敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
{
    double temp;//閿熸枻鎷锋椂閿熸枻鎷烽敓鏂ゆ嫹
    for(int i = 0; i < size-1; i++)
    {
...
double standard_deviation(const double array[],int len1,int len2){
    double avg = mean(array,len1,len2);//姹傚钩鍧囧€�
    double sum = 0.;
...
void diff_fabs(double *dat,int datalen,double*ret_buf,int *ret_len)
{
  ...
  for(i = 1; i<datalen; i++)
  {
    ret_buf[j++] = fabs(dat[i]-dat[i-1]);//求浮点数绝对值
  }
  *ret_len = j;
}
...
/** 閿熸枻鎷烽敓鏂ゆ嫹閿熺掸eakdet閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷峰€奸敓鏂ゆ嫹姣忛敓鏂ゆ嫹閿熸枻鎷峰€奸敓鏂ゆ嫹搴旈敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熻甯嫹c閿熸枻鎷烽敓鏂ゆ嫹閿熻緝甯嫹鎽洪敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹瑕侀敓鐭鎷烽敓鏂ゆ嫹鍊奸敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸彮甯嫹matlab涓€閿熼摪锝忔嫹閿熸枻鎷烽敓鐭鎷锋椂閿熸枻鎷锋敞閿熸枻鎷烽敓锟�1*/
