...
static void wconv1(const double * x, double * lo_d, double * hi_d, double * lo_out, double * hi_out, int level, int filter_len, int extend)
{
    ...
    wextend(x, y_wextend, level, y_wextend_len, extend);//�ź���������������extend�����ȣ�������2*extend����
    int outdata_length = y_wextend_len - filter_len + 1;//��������������
    double * lo_arry = (double *)malloc(sizeof(double)*outdata_length);//��������ĵ�ͨϵ�������ڴ�
    double * ho_arry = (double *)malloc(sizeof(double)*outdata_length);//��������ĸ�ͨϵ�������ڴ�
...
void wavedec(const double * ori_sign, double * out_sign, int * out_levels,int sign_len,int levels_len)
{
    ...
    -0.0149522583370482,-0.000302920514721367,0.00188995033275946};//�ֽ�ĵ�ͨ�˲���ϵ��
    ...
    0.0316950878114930,0.000542132331791148,-0.00338241595100613};//�ֽ�ĸ�ͨ�˲���ϵ��
    int filter_len = 16;//�˲�������
    int extend = filter_len-1;
    out_levels[levels_len-1]= sign_len;

    //һ���ֽ�
    double * lo_out1 = (double *)malloc(sizeof(double)*(out_levels[levels_len-1]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    double * hi_out1 = (double *)malloc(sizeof(double)*(out_levels[levels_len-1]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    ...
    //�����ֽ�
    double * lo_out2 = (double *)malloc(sizeof(double)*(out_levels[levels_len-2]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    double * hi_out2 = (double *)malloc(sizeof(double)*(out_levels[levels_len-2]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    ...
    //�����ֽ�
    double * lo_out3 = (double *)malloc(sizeof(double)*(out_levels[levels_len-3]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    double * hi_out3 = (double *)malloc(sizeof(double)*(out_levels[levels_len-3]+filter_len-1)/2);//1����ͨ�˲�ϵ��
    ...
    //�ֽ�֮��ķֽ�ϵ��Ϊ[lo_arry3;ho_arry3;ho_arry2;ho_arry1]
...
void waverec(const double * dec_details,int * levels,double * rec_sign)
{
    ...
    -0.0519458381077090,0.364441894835331,0.777185751700524,0.481359651258372,-0.0612733590676585,-0.143294238350810,0.00760748732491761,
    0.0316950878114930,-0.000542132331791148,-0.00338241595100613};//�ع��ĵ�ͨ�˲���ϵ��
    ...
    0.481359651258372,-0.777185751700524,0.364441894835331,0.0519458381077090,-0.0272190299170560,-0.0491371796736075,0.00380875201389062,
    0.0149522583370482,-0.000302920514721367,-0.00188995033275946};//�ع��ĸ�ͨ�˲���ϵ��
    int filter_len = 16;//�˲�������
    int extend = filter_len-1;
    /**�������ع�*/
    //��ͨ�˲��ع�
