...
void app_main(void)
{
    ...
    if (ret == ESP_ERR_NVS_NO_FREE_PAGES || ret == ESP_ERR_NVS_NEW_VERSION_FOUND) {
     ...
     ESP_ERROR_CHECK(ret);
      ...
      conn_mgr_init();//
       //conn_mgr_register_wifi_event(event_handle);
     ...
     xTaskCreate(&start_task, "start_task", 8192, NULL, 7, &start_task_Handler);
