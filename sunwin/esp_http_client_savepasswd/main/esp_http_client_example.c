...
uint16_t  Send_Data[30]={11,22,33,44,55,66,77,88,99,1010,1111,1212,1313,1414,1515,1616,1717,1818,1919,2020,2121,22};
...
void Get_CurrentData(char *dat)
{
    ...
    cJSON_AddStringToObject(root,"pushTime","2020-02-02 20:20 :20");
    cJSON *array=NULL;
    //创建一个数组
    ...
    cJSON *ArrayItem0=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem0,"pv",Send_Data[0]);
      cJSON_AddNumberToObject(ArrayItem0,"pr",Send_Data[1]);
      cJSON_AddNumberToObject(ArrayItem0,"vref",Send_Data[2]);
      cJSON_AddItemToArray(array,ArrayItem0);
          cJSON *ArrayItem1=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem1,"pv",Send_Data[3]);
      cJSON_AddNumberToObject(ArrayItem1,"pr",Send_Data[4]);
      cJSON_AddNumberToObject(ArrayItem1,"vref",Send_Data[5]);
      cJSON_AddItemToArray(array,ArrayItem1);
          cJSON *ArrayItem2=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem2,"pv",Send_Data[6]);
      cJSON_AddNumberToObject(ArrayItem2,"pr",Send_Data[7]);
      cJSON_AddNumberToObject(ArrayItem2,"vref",Send_Data[8]);
      cJSON_AddItemToArray(array,ArrayItem2);
          cJSON *ArrayItem3=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem3,"pv",Send_Data[9]);
      cJSON_AddNumberToObject(ArrayItem3,"pr",Send_Data[10]);
      cJSON_AddNumberToObject(ArrayItem3,"vref",Send_Data[11]);
      cJSON_AddItemToArray(array,ArrayItem3);
          cJSON *ArrayItem4=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem4,"pv",Send_Data[12]);
      cJSON_AddNumberToObject(ArrayItem4,"pr",Send_Data[13]);
      cJSON_AddNumberToObject(ArrayItem4,"vref",Send_Data[14]);
      cJSON_AddItemToArray(array,ArrayItem4);
          cJSON *ArrayItem5=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem5,"pv",Send_Data[15]);
      cJSON_AddNumberToObject(ArrayItem5,"pr",Send_Data[16]);
      cJSON_AddNumberToObject(ArrayItem5,"vref",Send_Data[17]);
      cJSON_AddItemToArray(array,ArrayItem5);
          cJSON *ArrayItem6=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem6,"pv",Send_Data[18]);
      cJSON_AddNumberToObject(ArrayItem6,"pr",Send_Data[19]);
      cJSON_AddNumberToObject(ArrayItem6,"vref",Send_Data[20]);
      cJSON_AddItemToArray(array,ArrayItem6);
          cJSON *ArrayItem7=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem7,"pv",Send_Data[21]);
      cJSON_AddNumberToObject(ArrayItem7,"pr",Send_Data[22]);
      cJSON_AddNumberToObject(ArrayItem7,"vref",Send_Data[23]);
      cJSON_AddItemToArray(array,ArrayItem7);
        cJSON *ArrayItem8=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem8,"pv",Send_Data[24]);
      cJSON_AddNumberToObject(ArrayItem8,"pr",Send_Data[25]);
      cJSON_AddNumberToObject(ArrayItem8,"vref",Send_Data[26]);
      cJSON_AddItemToArray(array,ArrayItem8);
              cJSON *ArrayItem9=cJSON_CreateObject();
      cJSON_AddNumberToObject(ArrayItem9,"pv",Send_Data[27]);
      cJSON_AddNumberToObject(ArrayItem9,"pr",Send_Data[28]);
      cJSON_AddNumberToObject(ArrayItem9,"vref",Send_Data[29]);
...
void app_main(void)
{
  ...
  //   initialise_wifi();//wifi链接
     app_wifi_initialise();
    xTaskCreate(&http_test_task, "http_test_task", 8192*2, NULL, 5, NULL);
}
