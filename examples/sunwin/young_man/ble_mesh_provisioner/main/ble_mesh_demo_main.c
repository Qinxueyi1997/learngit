...
unsigned char pvdf_buf[7]={0xff,0xf1,0xf2,0xf3,0xf4,0xf5,0xf6}; 
typedef struct {
    uint8_t  uuid[16];
    uint16_t unicast;
    uint8_t  elem_num;
        ...
        case ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_GET: {
            ...
            set_state.onoff_set.op_en = false;
              ...
              { 
                  ...
                  case 3 :{ set_state.onoff_set.onoff =  pvdf_buf[num];num=num+1;break;}
                  case 4 :{ set_state.onoff_set.onoff =  pvdf_buf[num];num=num+1;break;}
                  case 5 :{ set_state.onoff_set.onoff =  pvdf_buf[num];num=num+1;break;}
                  case 6 :{ set_state.onoff_set.onoff =  pvdf_buf[num];num=0;break;}
              }
