...
#define NUMBER_READINGS_CALIBRATION                     10
#define NUMBER_READINGS_CALIBRATION_DISCARDED           10
#define POSITIONING_DELAY                               5000

uint8_t calibration_mode = CALIBRATION_MODE_OFF;
...
{
    double pitch = atan(a_x / a_z)*57.2958;        // convert the radian to degrees x对于z的角度
    double roll = atan(a_y / a_z)*57.2958;         // convert the radian to degrees　y对于z的角度
